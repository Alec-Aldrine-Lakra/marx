...
<div class="editor-menu" (click)="buttonClicked($event)">
    <div class="left" #menuLeft>
        ...
        <div class="col" clickOutside (clickOutside)="closeListStylesPopover(); listStyle = false;">
            ...
            <button [class.active]="listStyle|| toolbarConfig?.orderedList || toolbarConfig?.unorderedList"
            ...
            <div class="popover small" *ngIf="listStyle" (click)="closeListStylesPopover()">
                <ul class="option-list">
                    <li data-id="orderedList">
                        <!-- List with Number -->
                        <button data-id="orderedList" [class.active]="toolbarConfig?.orderedList" type="button">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="1024" height="1024"
                                viewBox="0 0 1024 1024">
                                <path
                    ...
                    <li data-id="unorderedList">
                        <!-- List with bullets -->
                        <button data-id="unorderedList" [class.active]="toolbarConfig?.unorderedList" type="button">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="1024" height="1024"
                                viewBox="0 0 1024 1024">
                                <path
                                    d="M270 480.6h754v101.2h-754v-101.2zM270 812h754v101.2h-754v-101.2zM270 126.8h754v101.2h-754v-101.2zM36 126.8h101.2v101.2h-101.2v-101.2zM36 480.6h101.2v101.2h-101.2v-101.2zM36 812h101.2v101.2h-101.2v-101.2z">
        ...
        <div class="col" clickOutside (clickOutside)="closeAlignPopover()" *ngIf="editorConfig?.mode === 'prime'">
            <button (click)="alignPopover()" [class.active]="alignment" [csTooltip]="'Text Alignment'"
                placement="bottom" delay="0" type="button" [tooltipMandatory]="true">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="1024" height="1024"
                    viewBox="0 0 1024 1024">
            ...
            <div class="popover small" *ngIf="alignment">
                <ul class="option-list" (click)="alignment = false;">
                    <li data-id="left-align">
                        <!-- Left Align -->
                        <button data-id="left-align" type="button">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="1024" height="1024"
                                viewBox="0 0 1024 1024">
                    ...
                    <li data-id="center-align">
                        <!-- Center Align -->
                        <button data-id="center-align" type="button">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="1024" height="1024"
                                viewBox="0 0 1024 1024">
                                <path
                    ...
                    <li data-id="right-align">
                        <!-- Right Align -->
                        <button data-id="right-align" type="button">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="1024" height="1024"
                                viewBox="0 0 1024 1024">
                                <path
                    ...
                    <li data-id="justify-full">
                        <button data-id="justify-full" type="button">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="1024" height="1024"
                                viewBox="0 0 1024 1024">
                                <path
            ...
            *ngIf="editorConfig?.mode === 'prime' && editorConfig?.configFontStyle">
            <button (click)="fontStylePopover()" [csTooltip]="'Font Style'" placement="bottom" delay="0" type="button"
                ...
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024">
                    <path d="M99.306 127.3v321.786h372.176v-321.786h100.485v769.4h-100.485v-360.684h-372.176v360.684h-99.306v-769.4h99.306z"></path>
                    <path d="M927.051 248.412h-2.357l-129.068 69.544-19.449-76.616 162.072-86.635h85.751v741.995h-96.948v-648.288z"></path>
                </svg>
            </button>
        ...
        <div class="col" clickOutside (clickOutside)="closeFontSizePopover()" *ngIf="editorConfig?.mode === 'prime'">
            <button (click)="fontSizePopover()" [csTooltip]="'Font Size'" placement="bottom" delay="0"
                ...
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024">                   
                    <path d="M948.5 477.302v31.647c-34.585-27.804-78.213-44.306-125.909-44.306-110.99 0-201.183 90.193-201.183 201.183s90.193 201.183 201.183 201.183c47.47 0 91.324-16.728 125.909-44.306v31.647h75.5v-377.501h-75.5zM822.817 791.735c-69.397 0-125.909-56.512-125.909-125.909s56.512-125.909 125.909-125.909 125.909 56.512 125.909 125.909c-0.226 69.397-56.738 125.909-125.909 125.909z"></path>
                    <path d="M306.974 156.991l-306.974 697.586h82.508l105.113-238.933h238.481l105.113 238.933h82.508l-306.748-697.586zM220.849 540.143l86.125-195.532 86.125 195.532h-172.249z"></path>
                </svg>
            </button>
            ...
            <div class="popover small" *ngIf="fontSize">
                <ul class="option-list">
                    <li *ngFor="let size of [12,14,18,24,32,36,48]" attr.data-id="fontsize-{{size}}"
                        ...
                        <button attr.data-id="{{size}}" type="button">{{size}}</button>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="popover small" *ngIf="fontFamily">
                <ul class="option-list" (click)="fontFamily = false;">
                    <li *ngFor="let font of fontType" attr.data-id="font-{{font}}">
                        <button attr.data-id="font-{{font}}" [class.active]="toolbarConfig?.fontStyle === font" type="button">
                            {{font | titlecase}}
                        </button>
                    </li>
                </ul>
        ...
        <div class="col" clickOutside (clickOutside)="color = false;"
            *ngIf="editorConfig?.colorPalette && editorConfig?.mode === 'prime'">
            <button (click)="openColorTab()" [class.active]="color" [csTooltip]="'Color'"
                placement="bottom" delay="0" type="button" [tooltipMandatory]="true">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024">
            ...
            <div class="popover color-palette" *ngIf="color">
                <div class="tab">
                    <div class="tab-head">
                        <button (click)="fillColor[0] = true; fillColor[1] = false;" [class.active]="fillColor[0]"
                            [csTooltip]="'Background Color'" placement="bottom" delay="0" type="button"
                            [tooltipMandatory]="true">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024">
                                <path d="M0 932h1024v92h-1024v-92zM383.4 916.4c0 0 0 0 0 0 8.8 8.8 20.2 13.6 32.6 13.6 12.2 0 23.8-4.8 32.4-13.6l384-384c8.6-8.6 13.4-20.2 13.4-32.4s-4.8-23.8-13.4-32.4l-466.8-467.6-65 65.4 114.4 114.4-351.4 351.6c-18 18-18 47 0 65l319.8 320zM689 545.8l-273 273-255-255 18-18h510zM689 453.8h-418l209-209 209 209zM842.2 593c-27 39-72.2 111-72.2 154.2 0 60.6 49.4 110 110 110s110-49.4 110-110c0-40.4-39.2-106-72-154.2-8.2-12-22.4-19.2-37.8-19.2-15.6 0.2-29.6 7.4-38 19.2zM880 765.2c-9.8 0-17.8-8-18-17.8 0.4-4 5.6-17.8 18-40.6 12.4 23 17.6 36.6 18 40.6-0.2 9.8-8.2 17.8-18 17.8z"></path>
                            </svg>
                        </button>
                        <button (click)="fillColor[1] = true; fillColor[0] = false;" [class.active]="fillColor[1]"
                            [csTooltip]="'Text Color'" placement="bottom" delay="0" type="button"
                            [tooltipMandatory]="true">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024">
        ...
        <div class="col" clickOutside *ngIf="editorConfig?.mode === 'prime' && false">
            ...
            <div class="popup-mask" *ngIf="uploadImage">
                <div class="popover attach">
                    <div class="head">
                        <h3>Attach Image</h3>
                        <button class="close" (click)="clickOutsideImage()" type="button">&times;</button>
                    </div>
                    <div class="drag-drop" (dragenter)="dragenter($event)" (dragover)="dragover($event)"
                    ...
                    <div class="file-row" *ngIf="image">
                        <div class="file-col">
                            <button (click)="image = null;" type="button">
                                <span>&times;</span>
                            </button>
                            <div class="file-item">
                                <div class="file-image">
                    ...
                    <div class="footer">
                        <button class="cancel" (click)="clickOutsideImage()" type="button">Cancel</button>
                        <button type="button" (click)="saveImage()" class="upload">Save</button>
                    </div>
                </div>
            </div>
            <div class="alert-box" *ngIf="showAlert">
                <h1 id="alert-msg">{{alertMsg}}</h1>
                <button (click)="hideAlert()" id="ok-btn" type="button">OK</button>
            </div>
        </div>
        <!-- More options -->
        <div class="col" clickOutside *ngIf="moreOptionsButton">
            <button (click)="showMoreOptions()" [class.active]="moreOptions" type="button">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="1024" height="1024"
                    viewBox="0 0 1024 1024">
            ...
            <div class="popover small" *ngIf="moreOptions">
                <ul class="option-list">
                    ...
                    <li (click)="moreOptions = false;" data-id="quote" *ngIf="false">
                        <button data-id="quote" [class.active]="toolbarConfig?.quote" type="button">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024">
                    ...
                    <li (click)="moreOptions = false;" data-id="superscript">
                        <button [class.active]="toolbarConfig?.superscript" data-id="superscript" type="button">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024">
                    ...
                    <li (click)="moreOptions = false" data-id="subscript">
                        <button [class.active]="toolbarConfig?.subscript" data-id="subscript" type="button">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024">
                    ...
                    <li (click)="moreOptions = false;" data-id="increaseIndent">
                        <button data-id="increaseIndent" type="button">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024">
                    ...
                    <li (click)="moreOptions = false;" data-id="decreaseIndent">
                        <button data-id="decreaseIndent" type="button">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024">
    ...
    <div class="right" #menuRight>
        ...
        <div class="col" *ngIf="editorConfig?.buttonName">
            <button class="submit" data-id="submit" type="button"
